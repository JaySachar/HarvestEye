...
class SplashScreen(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        background_label.grid(row=1, column=1, sticky="sew")
        ...
        img_corner_topright.grid(row=0,column=2,padx=5, pady=5, sticky="ne")
        # Bind the resize event to the resize_image function
        #self.bind("<Configure>", resize_image)
        ...
        img_corner_bottomleft.grid(row=2,column=0,padx=5, pady=5, sticky="sw")
        # Bind the resize event to the resize_image function
        #self.bind("<Configure>", resize_image)
        ...
        img_logo.grid(row=2,column=2,padx=5, pady=20, sticky="se")
        img_logo.configure(bg='white')
        # Bind the resize event to the resize_image function
        #self.bind("<Configure>", resize_image)

        # Load the EXIT button
        photo = ImageTk.PhotoImage(Image.open(image_path+"btn-exit.png"))
